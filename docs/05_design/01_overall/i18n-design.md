...
- **Definition (Tailwind Config):**
  - `font-serif-en`: _Playfair Display_, serif (Classical & Elegant)
  - `font-serif-ja`: _Zen Old Mincho_, serif (Emotional & Readable)
  - `font-sans-en`: _Inter_, sans-serif
  - `font-sans-ja`: _Noto Sans JP_, sans-serif
