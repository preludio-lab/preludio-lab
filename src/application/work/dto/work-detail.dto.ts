...
const WorkTranslationDtoSchema = z
  .object({
    ...
    compositionPeriod: z.string().nullable(),
  })
  .strict();
...
export const WorkPartDetailDtoSchema = z
  .object({
    ...
    tsNumerator: z.number().nullable(),
    tsDenominator: z.number().nullable(),
    tsDisplayString: z.string().nullable(),
    bpm: z.number().nullable(),
    metronomeUnit: z.string().nullable(),
    impressionDimensions: z.record(z.string(), z.number()).nullable(),
...
export const WorkDetailDtoSchema = z
  .object({
    ...
    metronomeUnit: z.string().nullable(),
    impressionDimensions: z.record(z.string(), z.number()).nullable(),
    instrumentationFlags: z.record(z.string(), z.boolean()),
    catalogues: z.array(CatalogueDtoSchema),
    genres: z.array(z.string()),
