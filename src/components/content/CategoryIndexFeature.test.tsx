...
describe('CategoryIndexFeature', () => {
  ...
  it('renders list of contents', () => {
    render(<CategoryIndexFeature lang="en" category="works" contents={mockContents} />);
  ...
  it('renders empty state when no contents', () => {
    render(<CategoryIndexFeature lang="en" category="works" contents={[]} />);
  ...
  it('handles contents with missing metadata gracefully', () => {
    const incompleteContents = [{ slug: 'incomplete', category: 'works' } as any];

    render(<CategoryIndexFeature lang="en" category="works" contents={incompleteContents} />);
