          ...
          <div className="relative w-full sm:w-auto min-w-[160px]" ref={sortRef}>
            ...
            >
              <div className="flex items-center gap-2">
                <SortIcon
                  sort={state.sort || ContentSortOption.LATEST}
            ...
            <AnimatePresence>
              {isSortOpen && (
                ...
                >
                  {sorts
                    .filter(
                      (s) => s !== ContentSortOption.POPULAR && s !== ContentSortOption.TRENDING,
                    )
                    .map((sort) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <SortIcon
                              sort={sort as ContentSortOption}
        ...
        <div className="flex items-center gap-3 px-2 animate-fade-in-up overflow-x-auto pb-4 sm:pb-0 -mx-4 px-4 sm:mx-0 sm:px-0 scrollbar-hide">
          ...
          <div className="flex items-center gap-3 flex-nowrap sm:flex-wrap">
            ...
            {difficulties.map((diff) => {
              ...
              if (diff === 'Beginner')
                activeColorClass = 'bg-emerald-500 text-white shadow-emerald-200';
              if (diff === 'Intermediate')
                activeColorClass = 'bg-sky-500 text-white shadow-sky-200';
