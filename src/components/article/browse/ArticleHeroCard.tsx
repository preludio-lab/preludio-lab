            ...
            <Link href={`/${lang}/${category}/${slug}`} className="block h-full">
                <div className="p-8 sm:p-12">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <div
                            className="inline-flex items-center px-6 py-2.5 bg-primary text-white text-sm font-bold rounded-full transition-all shadow-md shadow-primary/20 group-hover:bg-primary-dark group-hover:shadow-lg"
                        >
                            {readMoreLabel}
