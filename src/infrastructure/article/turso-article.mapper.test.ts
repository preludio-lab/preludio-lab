...
describe('TursoArticleMapper', () => {
    it('should map database rows to Article domain object correctly', () => {
        ...
        // 実行
        const article = TursoArticleMapper.toDomain(mockArticleRow as any, mockTranslationRow as any, mdxContent);
    ...
    it('should handle missing optional fields and defaults', () => {
        ...
        const article = TursoArticleMapper.toDomain(mockArticleRow as any, mockTranslationRow as any, '');
