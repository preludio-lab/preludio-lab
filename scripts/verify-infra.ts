...
async function main() {
  ...
  try {
    const { ArticleMetadataDataSource } = await import('../src/infrastructure/article/metadata.ds');
    const { ArticleContentDataSource } = await import('../src/infrastructure/article/content.ds');
