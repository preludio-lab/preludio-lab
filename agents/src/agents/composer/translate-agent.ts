...
【最重要の制約事項】
- **summary の文字数制限**: **文字数は 200 文字以内（ターゲット言語の文字数換算）に厳守**してください。300 文字を超えるとバリデーションエラーとなり、一切保存できません。
- **簡潔さの徹底**: 特にフランス語、ドイツ語、スペイン語、イタリア語などは冗長になりやすいため、意味を損なわない範囲で極限まで短縮し、**1文、長くとも2文の極めて簡潔な要約**としてください。
